...
public class profiledAutoDriveDistance extends CommandBase {
  ...
  public profiledAutoDriveDistance(double distance, Drive drive) {
    m_drive = drive; 
  ...
  public profiledAutoDriveDistance(Drive drive) {
    m_drive = drive;
