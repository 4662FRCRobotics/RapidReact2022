...
public class AutoControl extends CommandBase {
    ...
    private Command m_cmdDrive2;
    private Step m_stepDrive2;
    ...
    private Command m_cmdIntakeCargo;
...
*/
     ...
     * };
     */
    // private Step<AutoStepCommand>[] m_step = (Step<AutoStepCommand>[]) new
    // Step[10];
    private Step[] m_step;
    ...
    public AutoControl(ConsoleJoystick console, Hopper hopper, Drive drive, Climb climb, Intake intake,
        ...
        //drive a far distance
        m_cmdDrive2 = new AutoDriveDistance(10, m_drive);
        m_autoStepCommand.addOption(AutoStepCommand.LAUNCH2, m_cmdLaunch2);
        m_stepDrive2 = new Step(AutoStepCommand.DRIVE1, () -> m_console.cnsl_btn_3.get());
        m_autoStepCommand.addOption(AutoStepCommand.DRIVE1, m_cmdDrive1);

        // driveIntake: gives ball to shooter
        m_cmdDriveIntake = new ParallelRaceGroup(new AutoDriveDistance(-1.5, m_drive),
                new IntakeCargo(m_hopper, m_intake));
        m_stepDriveIntake = new Step(AutoStepCommand.DRIVE_INTAKE);
        m_autoStepCommand.addOption(AutoStepCommand.DRIVE_INTAKE, m_cmdDriveIntake);
      
        m_autoStepCommand.addOption(AutoStepCommand.TURNP90, new AutoTurnAngle(90.0, m_drive));
        m_cmdTurn = new AutoTurnAngle(90.0, m_drive);
